...
if (confirmCode()) {
  ...
  $sql = "INSERT INTO `penyewaan` (`id_penyewaan`, `keperluan`, `nomor_gedung`, `instansi`, `penanggung_jawab`, `no_telp`, `email`, `tanggal_mulai`, `tanggal_akhir`, `jumlah_peserta`, `surat_pengantar`, `deskripsi`) VALUES ('$id_penyewaan','$keperluan','$nomor_gedung', '$instansi','$penanggung_jawab','$no_telp','$email','$tanggal_mulai','$tanggal_akhir','$jumlah_peserta', '$surat_pengantar','$deskripsi')";
