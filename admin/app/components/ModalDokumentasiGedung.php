    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="app/controller/DokumentasiGedung.php" method="GET">
          ...
          <div class="modal-body">
            <h4>Yakin ingin menghpus dokumentasi gedung <?= $data['nomor_gedung'] ?></h4>
            <input type="text" class="form-control" name="id_galeri" id="exampleInputPassword1" placeholder="Password" value="<?= $data['id_galeri'] ?>" hidden>
          </div>
          <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-default" data-dismiss="modal">Batalkan</button>
